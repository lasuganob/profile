export const knowledgeBase = [
  ...
  },
  {
    ...
    answer:
      "On the backend, I work primarily with Laravel and PHP, building and supporting business logic, REST API integrations, and database-driven applications using MySQL and PostgreSQL.",
  },
  {
    keywords: ["ai", "chatgpt", "codex", "claude", "ai tools"],
    answer:
      "I use AI tools like ChatGPT, Codex, and Claude to speed up debugging, refactoring, documentation, prototyping, and learning new technologies. They help me build faster while keeping solutions practical and maintainable.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "One of my key projects is a Slack-based Payslip Sender Automation that helps streamline payslip distribution and reduce repetitive manual work.",
  },
  {
    keywords: ["slack", "dm sender", "messaging tool"],
    answer:
      "I also built a Slack DM Sender Tool to support internal communication workflows and make staff messaging more efficient.",
  },
  {
    keywords: [
      "pwa",
    ...
    answer:
      "I’ve also built passion projects as PWAs using React + Vite, including a Cashflow App for tracking income and expenses, and a Grocery Checklist App for fast mobile-friendly shopping workflows.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "I care a lot about practical UI and UX. I enjoy turning complex business requirements into clean, responsive, and user-friendly interfaces that are easy to maintain.",
  },
  {
    keywords: ["remote", "team", "collaboration", "workflow"],
    answer:
      "I’m comfortable working with cross-functional teams, including developers, designers, QA, project managers, and non-technical stakeholders. I also put effort into clear documentation and maintainable implementation.",
  },
  {
